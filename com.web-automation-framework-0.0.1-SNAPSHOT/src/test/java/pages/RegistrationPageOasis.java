...
public class RegistrationPageOasis {
    private WebDriver driver;
    private WebDriverWait wait;

    public RegistrationPageOasis(WebDriver driver) {
        this.driver = driver;
    ...
    private WebElement registerButton;
     ...
     public void oR() {
        try {
            ...
            try {
                Thread.sleep(8500); // Wait for chat to show
                WebElement closeChatButton = wait.until(ExpectedConditions.elementToBeClickable(By.id("cross-btn")));
                ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView({block: 'center'});", closeChatButton);
                Thread.sleep(200);
