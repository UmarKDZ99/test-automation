...
public class RegistrationPageMosquito {
    private WebDriver driver;
    private WebDriverWait wait;

    public RegistrationPageMosquito(WebDriver driver) {
        this.driver = driver;
    ...
    public void mR() {
        try {
            ...
            // ✅ Scroll to and wait before clicking the submit button
            ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView({block: 'center'});", registerButton);
            Thread.sleep(10000); // 10-second delay before clicking
