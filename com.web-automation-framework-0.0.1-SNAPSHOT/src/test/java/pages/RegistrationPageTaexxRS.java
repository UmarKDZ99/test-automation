...
public class RegistrationPageTaexxRS {
    private WebDriver driver;
    private WebDriverWait wait;

    public RegistrationPageTaexxRS(WebDriver driver) {
        this.driver = driver;
